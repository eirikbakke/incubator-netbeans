 ...
 * ( http://mail.openjdk.java.net/pipermail/awt-dev/2017-January/012507.html ). The source files in
 ...
 *
 * The complete license header for the original files (identical for both files) is included
 * immediately below:
 */
/*
...
public class SmoothScrollPaneUI extends BasicScrollPaneUI {
  private static final Logger LOG = Logger.getLogger(SmoothScrollPaneUI.class.getName());
  ...
  private void mouseWheelMoved(MouseWheelEvent e) {
    ...
    actual shift key is not pressed, on both Windows and MacOS (though not on Java 8 on Windows). */
